...
public class ABB{
    ...
    /**Preorden (Preorder):
    Comienza visitando el nodo raíz.
    Luego, realiza un recorrido preorden en el subárbol izquierdo.
    Finalmente, realiza un recorrido preorden en el subárbol derecho.
    La secuencia resultante es: raíz - izquierdo - derecho.
    Ejemplo:
    Preorden: 9 - 2 - 1 - 6 - 4 - 8 - 16 - 11
    
    Inorden (Inorder):
    Realiza un recorrido inorden en el subárbol izquierdo.
    Luego, visita el nodo raíz.
    Finalmente, realiza un recorrido inorden en el subárbol derecho.
    La secuencia resultante es: izquierdo - raíz - derecho.
    Ejemplo:
    Inorden: 1 - 2 - 4 - 6 - 8 - 9 - 11 - 16

    Posorden (Postorder):
    Realiza un recorrido posorden en el subárbol izquierdo.
    Luego, realiza un recorrido posorden en el subárbol derecho.
    Finalmente, visita el nodo raíz.
    La secuencia resultante es: izquierdo - derecho - raíz.
    Ejemplo:
    Posorden: 1 - 4 - 8 - 6 - 2 - 11 - 16 - 9*/
